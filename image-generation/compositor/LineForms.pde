...
PGraphics drawWord(String aWord, long ts, int maxW, int maxH) {
...
/* ------------------------------------------------------------
 Top-level class that collects multiple line forms, places
 them in an image, and draws lines between them.
 ------------------------------------------------------------*/
...
class LineForms {
  ...
  LineForms(int w, int h, int _xsteps, int _ysteps, long _seed) {
    width = w;
    height = h;
    xsteps = _xsteps;
    ysteps = _ysteps;
...
/* ------------------------------------------------------------
 This is the sub-assembly that actually does the line drawing.
 See the line_forms sketch if you want to play with the 
 drawing code. 
 ------------------------------------------------------------*/
class LineForm {
  PGraphics surface;
